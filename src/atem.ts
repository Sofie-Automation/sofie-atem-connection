...
import { AtemCommandSenderMixin } from './lib/atemCommands'
...
export class BasicAtem extends EventEmitter<AtemEvents> implements IBasicAtem {
	 ...
	 */
	public createCommandBatch(): AtemCommandBatch {
		return new AtemCommandBatch(this)
	}
}

export class Atem extends AtemCommandSenderMixin<Promise<void>, typeof BasicAtem>(BasicAtem) {
